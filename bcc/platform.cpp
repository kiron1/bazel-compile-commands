...
output_of(std::string_view cmd, std::vector<boost::process::basic_cstring_ref<char>> args)
{
  try {
    ...
    boost::process::process proc(ctx, cmd_path, args, boost::process::process_stdio{ {}, out_pipe, err_pipe });
